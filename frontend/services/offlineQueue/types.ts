...
/** Query roots safe to persist for offline read (exclude heavy reports + paginated *_list). */
/** List transaksi/muatan/mobil/kas-bank bisa MB-an — stringify tiap persist blokir JS thread 1s+. */
