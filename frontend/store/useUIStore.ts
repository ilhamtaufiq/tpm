...
/** Garis tepi ikut palet tapi TIDAK disimpan di ThemeColors —
 *  key baru di sana akan memecah findPaletteId untuk user yang sudah punya state lama. */
...
export const colorPalettes: ColorPalette[] = [
    { id: 'tpm', name: 'TPM Default', colors: defaultColors, border: '#E5E7EB' },
    {
        id: 'ocean', name: 'Ocean',
