            ...
            <View className="space-y-5">
                ...
                <View>
                    ...
                    <View className="flex-row items-center space-x-4">
                        <View className="w-24 h-24 bg-background border border-transparent rounded-2xl items-center justify-center overflow-hidden">
                        ...
                        <View className="flex-1 space-y-2">
                            ...
                            <Pressable onPress={takePhoto} className="flex-row items-center bg-surface border border-transparent rounded-xl px-3 py-2.5 active:bg-background"><Camera size={16} color="#6B7280" /><Typography className="text-textGray font-bold text-xs ml-2">Ambil Foto</Typography></Pressable>
                        </View>
                    </View>
                </View>
                ...
                <View>
                    ...
                    <Typography className="mb-3 text-textGray text-[11px] ml-1">
                    ...
                    <View className="space-y-3">
                        ...
                        <View className="flex-row items-center space-x-3">
                            <View className="flex-1">
                                <TextInput
                                    className="bg-background border border-transparent rounded-2xl px-4 py-3.5 text-textMain font-medium focus:border-primary focus:bg-primary/5 text-xs italic"
                ...
                <View>
                    ...
                    <TextInput className="bg-background border border-transparent rounded-2xl px-4 py-3.5 text-textMain font-medium focus:border-primary focus:bg-primary/5" placeholder="Contoh: Oli Yamalube" placeholderTextColor="#9CA3AF" value={form.nama} onChangeText={(t) => setForm({ ...form, nama: t })} />
                </View>
                ...
                <View className="flex-row space-x-3">
                    <View className="flex-1">
                        ...
                        <TextInput className="bg-background border border-transparent rounded-2xl px-4 py-3.5 text-textMain font-medium focus:border-primary focus:bg-primary/5" placeholder="0" placeholderTextColor="#9CA3AF" keyboardType="numeric" value={form.harga_beli} onChangeText={(t) => setForm({ ...form, harga_beli: formatNumber(t) })} />
                    </View>
                    <View className="flex-1">
                        <Typography className="mb-2 text-textGray font-bold text-[10px] uppercase tracking-widest ml-1">Harga Jual</Typography>
                        <TextInput className="bg-background border border-transparent rounded-2xl px-4 py-3.5 text-textMain font-medium focus:border-primary focus:bg-primary/5" placeholder="0" placeholderTextColor="#9CA3AF" keyboardType="numeric" value={form.harga_jual} onChangeText={(t) => setForm({ ...form, harga_jual: formatNumber(t) })} />
                    </View>
                </View>
                ...
                <View className="flex-row space-x-3">
                    ...
                    <View className="flex-1">
                        ...
                        <TextInput className="bg-background border border-transparent rounded-2xl px-4 py-3.5 text-textMain font-medium focus:border-primary focus:bg-primary/5" placeholder="5" placeholderTextColor="#9CA3AF" keyboardType="numeric" value={form.stok_minimum} onChangeText={(t) => setForm({ ...form, stok_minimum: t })} />
                    </View>
                </View>
                ...
                <View className="flex-row space-x-3">
                    <View className="flex-1">
                        ...
                        <TextInput className="bg-background border border-transparent rounded-2xl px-4 py-3.5 text-textMain font-medium focus:border-primary focus:bg-primary/5" placeholder="pcs" placeholderTextColor="#9CA3AF" value={form.satuan} onChangeText={(t) => setForm({ ...form, satuan: t })} />
                    </View>
                    <View className="flex-1">
                        <Typography className="mb-2 text-textGray font-bold text-[10px] uppercase tracking-widest ml-1">Kategori</Typography>
                        <TextInput className="bg-background border border-transparent rounded-2xl px-4 py-3.5 text-textMain font-medium focus:border-primary focus:bg-primary/5" placeholder="Umum" placeholderTextColor="#9CA3AF" value={form.kategori} onChangeText={(t) => setForm({ ...form, kategori: t })} />
                    </View>
                </View>
                ...
                <View>
                    ...
                    <TextInput className="bg-background border border-transparent rounded-2xl px-4 py-3.5 text-textMain font-medium focus:border-primary focus:bg-primary/5" placeholder="Contoh: Rak A-1" placeholderTextColor="#9CA3AF" value={form.lokasi_rak} onChangeText={(t) => setForm({ ...form, lokasi_rak: t })} />
                </View>

                {/* Catatan */}
                <View>
                    <Typography className="mb-2 text-textGray font-bold text-[10px] uppercase tracking-widest ml-1">Catatan (Opsional)</Typography>
                    <TextInput className="bg-background border border-transparent rounded-2xl px-4 py-3.5 text-textMain font-medium focus:border-primary focus:bg-primary/5 min-h-[80px]" placeholder="Keterangan tambahan..." placeholderTextColor="#9CA3AF" value={form.catatan} onChangeText={(t) => setForm({ ...form, catatan: t })} multiline textAlignVertical="top" />
                </View>
