...
import { Search, MapPin, X, Check, Calendar } from 'lucide-react-native';
                        ...
                        {value ? (
                            <>
                                ...
                                <View className="flex-row items-center">
                                    ...
                                    <Typography variant="caption" className="text-primary/60 text-[10px] font-black tracking-tighter uppercase">
