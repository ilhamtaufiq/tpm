...
export const APP_ROUTES: AppRoute[] = [
    ...
    { id: 'bengkel-transaksi', label: 'Tambah Transaksi Bengkel', description: 'Buat transaksi servis dan sparepart', path: '/bengkel/transaksi', icon: Receipt, category: 'Bengkel', keywords: ['kasir', 'transaksi', 'servis', 'sparepart'] },
    ...
    { id: 'angkut-armada-form', label: 'Form Armada', description: 'Tambah atau ubah data armada', path: '/jasa-angkut/armada/form', icon: Truck, category: 'Logistik', keywords: ['form', 'tambah', 'edit', 'armada'] },
    { id: 'angkut-muatan-form', label: 'Form Muatan', description: 'Input muatan jasa angkut', path: '/jasa-angkut/muatan/form', icon: Receipt, category: 'Logistik', keywords: ['muatan', 'ritase', 'ongkos'] },
    ...
    { id: 'supir-form', label: 'Form Supir', description: 'Tambah atau ubah data supir', path: '/jasa-angkut/supir/form', icon: User, category: 'Logistik', keywords: ['driver', 'supir', 'form'] },
    ...
    { id: 'master-asset', label: 'Data Asset', description: 'Kelola asset operasional', path: '/master-data/asset', icon: Database, category: 'Master', keywords: ['aset', 'asset', 'inventaris'] },
    ...
    { id: 'lap-stock-sparepart', label: 'Lap. Stock Sparepart', description: 'Rekap stok sparepart bengkel', path: '/laporan/stock-sparepart', icon: BarChart3, category: 'Laporan', keywords: ['stok', 'sparepart', 'barang'] },
    { id: 'lap-pembelian-sparepart', label: 'Lap. Pembelian Sparepart', description: 'Rekap pembelian sparepart', path: '/laporan/pembelian-sparepart', icon: BarChart3, category: 'Laporan', keywords: ['pembelian', 'sparepart', 'kulakan'] },
    { id: 'lap-pembelian-mobil', label: 'Lap. Pembelian Mobil', description: 'Rekap pembelian unit mobil', path: '/laporan/pembelian-mobil', icon: BarChart3, category: 'Laporan', keywords: ['pembelian', 'mobil', 'unit'] },
    { id: 'lap-perubahan-modal', label: 'Perubahan Modal', description: 'Laporan perubahan modal', path: '/laporan/perubahan-modal', icon: BarChart3, category: 'Laporan', keywords: ['modal', 'ekuitas'] },
    { id: 'lap-neraca', label: 'Neraca', description: 'Laporan posisi keuangan', path: '/laporan/neraca', icon: BarChart3, category: 'Laporan', keywords: ['neraca', 'aset', 'hutang'] },
    ...
    { id: 'fin-akun', label: 'Akun Kas', description: 'Daftar akun dan saldo kas', path: '/finance/akun', icon: Wallet, category: 'Finance', keywords: ['akun', 'kas', 'saldo'] },
    ...
    { id: 'fin-user-cash', label: 'Catatan Cash User', description: 'Kelola saldo cash yang dipegang user', path: '/finance/user-cash', icon: Wallet, category: 'Finance', keywords: ['cash', 'user', 'saldo', 'dompet'] },
    ...
    { id: 'fin-hutang', label: 'Hutang Usaha', description: 'Tagihan yang harus dibayar', path: '/finance/hutang', icon: Wallet, category: 'Finance', keywords: ['hutang', 'tagihan', 'bayar'] },
    { id: 'fin-investor', label: 'Pencairan Investor', description: 'Kelola pencairan dana investor', path: '/finance/pencairan-investor', icon: Wallet, category: 'Finance', keywords: ['investor', 'pencairan', 'modal'] },
