    ...
    return `
        ...
        <body>
            ...
            <table>
                ...
                <tr><td>Biaya Persiapan (Pajak, BBN, dll)</td><td class="amount negative">(${formatCurrency(data.units.mobil.beban_operasional)})</td></tr>
                <tr><td>Biaya Perbaikan (Workshop)</td><td class="amount negative">(${formatCurrency(data.units.mobil.maintenance || 0)})</td></tr>
    ...
    return `
        ...
        <body>
            ...
            <table>
                ...
                ${adjustment < 0 ? `
                <tr class="sub-item">
                    <td>Pencairan Modal & Bagi Hasil Investor</td>
